...
namespace TuningKOZ
{
    partial class RiserStatusControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.stateStartButton = new TuningKOZ.View.StatusControl(this.components);
            this.stateBigValve = new TuningKOZ.View.StatusControl(this.components);
            this.stateSmallValve = new TuningKOZ.View.StatusControl(this.components);
            this.stateReady = new TuningKOZ.View.StatusControl(this.components);
            this.stateWorkPosition = new TuningKOZ.View.StatusControl(this.components);
            this.stateCheckGround = new TuningKOZ.View.StatusControl(this.components);
            this.stateCheckLevel = new TuningKOZ.View.StatusControl(this.components);
            this.stateHandButton = new TuningKOZ.View.StatusControl(this.components);
            this.flowLayoutPanel3 = new System.Windows.Forms.FlowLayoutPanel();
            this.stateAlarmLevel = new TuningKOZ.View.StatusControl(this.components);
            this.stateAlarmLevelMax = new TuningKOZ.View.StatusControl(this.components);
            this.stateAlarmLevelMin = new TuningKOZ.View.StatusControl(this.components);
            this.stateAnalogLevelMax = new TuningKOZ.View.StatusControl(this.components);
            this.stateAnalogLevelMin = new TuningKOZ.View.StatusControl(this.components);
            this.stateStopButton = new TuningKOZ.View.StatusControl(this.components);
            this.stateReadyError = new TuningKOZ.View.StatusControl(this.components);
            this.stateBigValveError = new TuningKOZ.View.StatusControl(this.components);
            this.stateSmallValveError = new TuningKOZ.View.StatusControl(this.components);
            this.stateGroundError = new TuningKOZ.View.StatusControl(this.components);
            this.stateLevelError = new TuningKOZ.View.StatusControl(this.components);
            this.label2 = new System.Windows.Forms.Label();
            this.tableLayoutPanel2 = new System.Windows.Forms.TableLayoutPanel();
            this.flowLayoutPanel4 = new System.Windows.Forms.FlowLayoutPanel();
            this.commandOpenBigValve = new TuningKOZ.View.StatusControl(this.components);
            this.commandOpenSmallValve = new TuningKOZ.View.StatusControl(this.components);
            this.flowLayoutPanel5 = new System.Windows.Forms.FlowLayoutPanel();
            this.commandGreenLampOn = new TuningKOZ.View.StatusControl(this.components);
            this.commandBlueLampOn = new TuningKOZ.View.StatusControl(this.components);
            ...
            this.stopKind0 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind1 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind2 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind3 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind4 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind5 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind6 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind7 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind8 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind9 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind10 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind11 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind12 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind13 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind14 = new TuningKOZ.View.StatusControl(this.components);
            this.stopKind15 = new TuningKOZ.View.StatusControl(this.components);
            ...
            this.flowLayoutPanel6.Size = new System.Drawing.Size(448, 71);
